...
$sql = "select * from `mark_tbl` where stud_id = '".$_SESSION['id']."' ";
                  ...
                  <table class="table">
                    ...
                    <?php
						...
						<tr>
							...
							<td>
								<?php echo $row['acd_year']; ?>
							</td>
							<td> <img width="100px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['marksheet_file']); ?>" /> </td>
							<td>
								<?php echo $row['created_dt']; ?></td>
						</tr>
						<?php
                            $i++;
                        }
