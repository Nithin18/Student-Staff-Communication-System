                    ...
                    <?php
                        ...
                        ?>
							<tr>
								...
								<td>
									<?php echo $row['stud_mail']; ?>
								</td>
								<td>
									<?php echo $row['stud_phone']; ?>
								</td>
								<td>
									<?php echo $row['status']; ?>
								</td>
                <td><a href="Studentedit.php?id=<?php echo $row['stud_id']; ?>" >Edit</a> </td>	
                <td><a href="Studentdelete.php?id=<?php echo $row['stud_id']; ?>" >Delete</a> </td>							
                </tr>
							<?php
