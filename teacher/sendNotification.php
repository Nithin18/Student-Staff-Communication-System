        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 0.8rem;">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Notification Panel</h4>
              </div>
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-5 pr-2">
                    <div class="form-group">
                      ...
                      <textarea name="notisend" id="materialContactFormMessage" class="form-control md-textarea" rows="3"></textarea>                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-5 pr-2">
                    ...
                    <div class="btn btn-primary btn-sm float-left"> <span>Choose files</span>
						        <input type="file" name="notifile"> </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-5 pr-2">
                      <div class="form-group">
                        ...
                        <input placeholder="Select from date" name="create_date" type="datetime-local" id="example" class="form-control"> </div>
                      </div>
                    </div>
                    ...
                    <input type="submit" name="sendinfo"  value="Send Info"class="btn btn-primary btn-round">
                          ...
                          <?php
                            ...
                            {	 
                              $regno = $_POST['regno']; 
                              $info = $_POST['notisend'];
                              $image = $_FILES['notifile']['tmp_name'];
                              $imageContent = addslashes(file_get_contents($image));
                              $create_dt = $_POST['create_date'];
                              ...
                              $sql = "INSERT INTO notify (stud_id,notification,nfile,created_dt)
                              VALUES ('$regno','$info','$imageContent','$create_dt')";
